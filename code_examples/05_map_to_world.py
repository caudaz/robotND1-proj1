...
# Generate a random value in this range (floats from 0 to 360)
rover_yaw = np.random.random(1)*360

# Generate a random rover position in world coords
# range from 20 to 180 to avoid the edges in a 200 x 200 pixel world
...
def pix_to_world(xpix, ypix, xpos, ypos, yaw, world_size, scale):
    ...
    # Clip to world_size
    # Throws away xpix_tran that do not fall between the 0 to world_size-1 range
